...
export class MailService {
  ...
  async sendAddPointConfirmation(to: string, email: string, code: string, point: number): Promise<void> {
  ...
  async sendCheckoutConfirmation(to: string, orderCode: string, code: string, amount: number): Promise<void> {
    try {
  ...
  async sendPaymentSuccess(to: string, orderCode: string, amount: number, paymentDate: string): Promise<void> {
  ...
  async sendAdminCredentials(to: string, credentials: { email: string; password: string }): Promise<void> {
